...
AdGuard rebuilt their extension from scratch for Manifest V3 and it is the most capable MV3-native ad blocker available as of 2026. Their team invested in pushing the limits of `declarativeNetRequest` — including dynamic rule updates, cosmetic filtering via content scripts, and a large custom filter list maintained independently.
