...
It depends on the number type. Free VoIP numbers from services like TextNow or Google Voice are frequently rejected by major dating platforms, which now run carrier-type checks at signup. Carrier-backed virtual numbers — like those provided by Surfshark Alt-Number — pass these checks because they are provisioned through actual carrier infrastructure rather than a VoIP pool. If you have tried a [free virtual number](https://snipstack.io/free-virtual-number-without-data-plan-2026/) and been rejected, switching to a carrier-backed service typically resolves the issue.
