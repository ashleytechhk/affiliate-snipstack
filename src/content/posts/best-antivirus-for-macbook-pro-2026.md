...
3. **Never call a phone number shown in a pop-up** — Apple and Microsoft do not show phone numbers in browser alerts. Any pop-up with a phone number is a scam. Close the browser tab (press Command + W) and do nothing else.
